...
def paid_shop():
    ...
    while not (daily & weekly & monthly):
        ...
        # 每日
        player.match_and_click_by_order_with_shift([('paid_shop_beginner_special_support_selected', 0, 120), ('paid_shop_free_diamond', 0, 0)])
        front_player.match_and_click_with_delay('REWARD', 2)
        ...
        if paid_shop_free_diamond_daily_sold_out:
            daily = True
        # 每周
        player.match_and_click_by_order_with_shift([('paid_shop_beginner_special_support_unselected', 0, 240), ('paid_shop_free_diamond', 0, 0)])
        front_player.match_and_click_with_delay('REWARD', 2)
        ...
        if paid_shop_free_diamond_weekly_sold_out:
            weekly = True
        # 每月
        player.match_and_click_by_order_with_shift([('paid_shop_beginner_special_support_unselected', 0, 360), ('paid_shop_free_diamond', 0, 0)])
        front_player.match_and_click_with_delay('REWARD', 2)
...
# 远征
def trip():
    front_player.match_and_click_with_delay('base', 5)
    front_player.match_and_click_with_delay('trip', 5)
    if front_player.match('gain_all_reward') is not None:
